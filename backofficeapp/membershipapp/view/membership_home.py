...
def membership_home(request):
    try:
        ...
        print 'Exception ', e
    return render(request, 'backoffice/membership/supplier_list.html', data)
...
def membership_details(request):
    try:
        ...
        print 'Exception ', e
    return render(request, 'backoffice/membership/membership_details.html', data)
...
def add_membership_details(request):
    if not request.user.is_authenticated():
        ...
        try:
            ...
            print 'Exception ', e
        return render(request, 'backoffice/membership/add-membership-details.html', data)
...
def membership_category(request):
    try:
        ...
        print 'Exception ', e
    return render(request, 'backoffice/membership/Membership_category.html', data)
...
def add_membership_category(request):
    if not request.user.is_authenticated():
        ...
        try:
            ...
            print 'Exception ', e
        return render(request, 'backoffice/membership/add_membership_category.html', data)        
...
def industry_details(request):
    try:
        ...
        print 'Exception ', e
    return render(request, 'backoffice/membership/industry_details.html', data)    
...
def add_industry_details(request):
    if not request.user.is_authenticated():
        ...
        try:
            ...
            print 'Exception ', e
        return render(request, 'backoffice/membership/add_industry_details.html', data)   
...
def legal_details(request):
    try:
        ...
        print 'Exception ', e
    return render(request, 'backoffice/membership/legal_details.html', data)    
...
def add_legal_details(request):
    if not request.user.is_authenticated():
        ...
        try:
            ...
            print 'Exception ', e
        return render(request, 'backoffice/membership/add_legal_details.html', data)  
...
def top3_members(request):
    try:
        ...
        print 'Exception ', e
    return render(request, 'backoffice/membership/top_3_members.html', data)    
...
def add_top3_members(request):
    if not request.user.is_authenticated():
        ...
        try:
            ...
            print 'Exception ', e
        return render(request, 'backoffice/membership/add_top3_members.html', data)      
...
def rate_card(request):
    if not request.user.is_authenticated():
        ...
        if rate_card_obj:
            ...
            rate_card_list.append(rate_card_data)
        telephone_rate_card_obj = TelephoneEnquiryRateCard.objects.filter(city_place_id=str(first_city),
                                                                          rate_card_status='1')
        ...
        try:
            ...
            for cat_obj in category_list:
                ...
                if (cat_obj.category_status == '1'):
                    ...
                    actions = active
                list = {'active_advert': active_advert, 'category_id': category_id, 'status': status,
                        'cat_color': cat_color, 'category_name': category_name, 'actions': actions,
                        'city_name': city_list,
                        'creation_date': creation_date, 'category_updated_by': category_updated_by,
                        'category_created_by': category_created_by, 'updation_date': updation_date,
                        'updated_by': cat_obj.category_updated_by}
                final_list.append(list)
            data = {'country_list': country_list, 'username': request.session['login_user'], 'success': 'true',
                    'data': final_list}
        except IntegrityError as e:
            print e
            data = {'username': request.session['login_user'], 'success': 'false',
                    'message': 'Error in  loading page. Please try after some time'}
        return render(request, 'Admin/category.html', data)
...
def add_advert(request):
    if not request.user.is_authenticated():
        ...
        data = {'country_var': country_var, 'state_var': state_var, 'city_var': city_var, 'sort_by': sort_by,
                'country_id': country_id, 'state_id': state_id, 'city_place_id': city_place_id,
                'supplier_name': supplier_name, 'tax_list': tax_list, 'advert_service_list': advert_service_list,
        ...
        if business_id:
            ...
            data = {'country_var': country_var, 'state_var': state_var, 'city_var': city_var, 'sort_by': sort_by,
                    'country_id': country_id, 'state_id': state_id, 'city_place_id': city_place_id,
                    'supplier_name': supplier_name, 'cat_amenities': cat_amenities, 'tax_list': tax_list,
                    'advert_service_list': advert_service_list, 'service_list': service_list,
                    'username': request.session['login_user'], 'supplier_id': supplier_id, 'user_id': user_id,
                    'advert_flag': advert_flag,'top_advert':top_advert,'advert_slider':advert_slider,
                            ...
                            if user.is_active:
                                ...
                                if user_profile_obj.user_status == "1":
                                    try:
                                        ...
                                        request.session['user_id'] = int(user_profile_obj.user_id)
                                        request.session['user_place_id'] = int(
                                            user_profile_obj.city_place_id.city_place_id)
                                        request.session[
                                            'first_name'] = user_profile_obj.user_first_name  # + '' + user_profile_obj.user_last_name
                                        login(request, user)
        ...
        try:
            ...
            for role_obj in user_role_list:
                ...
                if role_obj.role_status == '1':
                    ...
                    delete = '<a id="' + str(role_name) + '" onclick="delete_user_role(' + str(
                        role_id) + ',this.id)" style="text-align: center;letter-spacing: 5px;width:15%;" title="Delete"  ><i class="fa fa-trash"></i></a>'
                    status = 'Active'
                    actions = edit + delete
                else:
                    status = 'Inactive'
                    active = '<a class="col-md-2" id="' + str(role_name) + '" onclick="active_service(' + str(
                        role_id) + ',this.id);" style="text-align: center;letter-spacing: 5px;width:10%;margin-left: 22px !important;" title="Activate" class="edit" data-toggle="modal" href="#edit_subscription"><i class="fa fa-repeat"></i></a>'
                    actions = active

                list = {'role_name': role_name, 'actions': actions, 'role_id': role_id, 'from_date': from_date,
                        'to_date': to_date,
        ...
        try:
            ...
            try:
                ...
                if request.POST['check_image'] == "1":
                    request.FILES['city_image'].name = 'cityID_' + str(city_obj.city_place_id) + '_' + request.FILES[
                        'city_image'].name
            ...
            try:
                ...
                if splitId[0] == 'old':
                    ...
                    if interest_name != "":
                        ...
                        if interest_img != '':
                            interest_img.name = 'placeID_' + str(place_obj) + '_' + interest_img.name
    ...
    try:
        ...
        for interest_name, interest_img in zipped_wk:
            ...
            if interest_name != '' and interest_img != '':
                ...
                interest_name_obj.save()
                interest_img.name = 'placeID_' + str(interest_name_obj) + '_' + interest_img.name
                interest_name_obj.place_image = interest_img
                interest_name_obj.save()
            data = {'success': 'true'}
    ...
    if not request.user.is_authenticated():
        ...
        try:
            ...
            for adv in city_obj:
                ...
                temp_obj = {'edit': edit, 'delete': delete, 'city_image': city_image, 'city_place_id': city_place_id,
                            'city_name': adv.city_id.city_name, 'country': adv.country_id.country_name,
                            'state': adv.state_id.state_name, 'status': status}
                adv_list.append(temp_obj)

            data = {'success': 'true', 'country': country, 'username': request.session['login_user'],
                    'city_status': status1, 'state': state, 'city_count': city_obj1, 'city_list': adv_list,
                    'country_list': get_country(request), 'state_list': get_states(request)}
        ...
        try:
            ...
            if point_of_intrest:
                ...
                for place in point_of_intrest:
                    try:
                        place_image = place.place_image.url
            ...
            if shop_name:
                ...
                for shop in shop_name:
                    place_image = shop.place_image.url
                    file_name = place_image[47:]
                    place_data = {
            ...
            if hospital:
                ...
                for hosp in hospital:
                    place_image = hosp.place_image.url
                    file_name = place_image[47:]
                    place_data = {
            ...
            if college:
                ...
                i = 0;
                for clg in college:
                    place_image = clg.place_image.url
        ...
        try:
            ...
            try:
                if request.method == "GET":
                    ...
                    user_email_id = user_obj.usre_email_id
                    user_contact_no = user_obj.user_contact_no
                    data = {'success': 'true', 'city_id': city_id, 'city_places_list': get_city_places(request),
                            'user_role_list': user_role_list, 'role_name': role_name, 'role_id': role_id,
        ...
        try:
            ...
            try:
                if request.method == "GET":
                    ...
                    user_email_id = user_obj.usre_email_id
                    user_contact_no = user_obj.user_contact_no
                    data = {'success': 'true', 'user_role_list': user_role_list, 'role_name': role_name, 'role_id': role_id,
                            'user_first_name': user_first_name, 'user_last_name': user_last_name,
                            'user_email_id': user_email_id, 'user_contact_no': user_contact_no}
            except IntegrityError as e:
                print e
            ...
            if request.POST:
                ...
                try:
                    ...
                    if user:
                        ...
                        user_obj.city_place_id = City_Place.objects.get(
            ...
            if sort_var == 'show_all':
                ...
                for user_obj in user_list:
                    if user_obj.user_role:
                        ...
                        user_contact_no = user_obj.user_contact_no
                        edit = '<a id="' + str(
                            user_obj) + ' " style="text-align: center;letter-spacing: 5px;width:15%;" title="Edit" class="edit" data-toggle="modal" href="/edit-user-detail/?user_id=' + str(
                            user_obj) + '"><i class="fa fa-pencil"></i></a>'
                        delete = '<a id="' + str(
                            user_obj) + '" onclick="delete_user_detail(this.id)" style="text-align: center;letter-spacing: 5px;width:15%;" title="Delete"  ><i class="fa fa-trash"></i></a>'
                        if user_obj.user_status == "1":
                            ...
                            status = 'Inactive'
                            actions = '<a id="' + str(
                                user_obj) + '" onclick="reactivate_user(this.id)" style="text-align: center;letter-spacing: 5px;width:15%;" title="Reactivate"><i class="fa fa-undo"></i></a>'
                        list = {'user_name': user_name, 'actions': actions, 'role_id': role_id,
                                'usre_email_id': usre_email_id, 'user_contact_no': user_contact_no, 'status': status}
                        final_list.append(list)
                        ...
                        if user_obj.user_role:
                            ...
                            if user_obj.user_status == "1":
                                ...
                                actions = '<a id="' + str(
                                    user_obj) + '" onclick="reactivate_user(this.id)" style="text-align: center;letter-spacing: 5px;width:15%;" title="Reactivate"><i class="fa fa-undo"></i></a>'
                            list = {'user_name': user_name, 'actions': actions, 'role_id': role_id,
                                    'usre_email_id': usre_email_id, 'user_contact_no': user_contact_no,
                                    'status': status}
            ...
            for user_obj in user_list:
                if user_obj.user_role:
                    ...
                    if user_obj.user_status == "1":
                        ...
                        actions = '<a id="' + str(
                            user_obj) + '" onclick="reactivate_user(this.id)" style="text-align: center;letter-spacing: 5px;width:15%;" title="Reactivate"><i class="fa fa-undo"></i></a>'
                    list = {'city': city, 'user_name': user_name, 'actions': actions, 'role_id': role_id,
                            'usre_email_id': usre_email_id, 'user_contact_no': user_contact_no, 'status': status}
                    final_list.append(list)
                data = {'success': 'true', 'data': final_list}
        except IntegrityError as e:
