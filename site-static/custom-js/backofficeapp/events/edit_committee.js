 ...
 $("#update-continue").click(function(event) { 	 	
	if (validateData()) {
        event.preventDefault(); 
    	  ...
    	  formData.append("committee_id",$('#hidden_committee_id').val());
        ...
        $.ajax({            
             type: "POST",
       		 url: "/backofficeapp/update-committee-form/",
       		 data : formData,
				 cache: false,
		       processData: false,
		 		 contentType: false, 
             success: function(response) {
	                ...
	                if (response.success == "true") {
	                    bootbox.alert("<span class='center-block text-center'>Committee updated successfully</span>",function(){
